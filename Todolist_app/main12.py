#todos = []
def read_todos(filepath): #Function(Parameters)
    # filepath = "todos.txt"
...
def write_todos(filepath, todos_w):
...
while True:
   ...
   #Match-case Statement replaced by If-else Statement
    ...
    if action.startswith('add'):
        ...
        #file.close()
        todos = read_todos("todos.txt") #Function(Arguments) #Global Variable
        # filepath = "todos.txt"
        ...
        #file.close()
        write_todos("todos.txt", todos) # filepath = "todos.txt" # todos_w = todos
